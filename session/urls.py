...
urlpatterns = [
    ...
    path('api/sessions/session/<int:id>/register-volunteer', insert_volunteer_in_session,
          name = "api_register_volunteer"),
    path('api/sessions/session/<int:idSession>/approve-volunteer/<int:idVolunteer>',
          approve_volunteer_in_session, name = "api_approve_volunteer"),
    path('api/sessions/session/<int:idSession>/reject-volunteer/<int:idVolunteer>',
          reject_volunteer_in_session, name = "api_reject_volunteer"),
