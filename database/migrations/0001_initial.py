# Generated by Django 4.0.4 on 2022-06-19 02:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='OrganizacionOferente', to=settings.AUTH_USER_MODEL)),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SesionSolicitada', to='database.session')),
                ('volunteer', models.ManyToManyField(related_name='Solicitante', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Turn',
